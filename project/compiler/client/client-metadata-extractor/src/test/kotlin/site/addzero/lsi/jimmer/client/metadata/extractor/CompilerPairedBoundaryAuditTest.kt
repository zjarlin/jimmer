...
class CompilerPairedBoundaryAuditTest {

    @Test
    fun `paired apt and ksp chains stay free of direct poet business APIs`() {
        for (file in pairedBoundarySources()) {
    ...
    private fun pairedBoundarySources(): List<Path> {
        ...
        return CompilerAuditTestSupport.collectSourceFiles(roots).sorted()
    }
}
