...
data class JimmerImmutableDraftTypePlan(
...
data class JimmerImmutableDraftPropPlan(
...
data class JimmerImmutableAssociatedIdContract(
    val name: String,
    val targetIdPropId: LsiSymbolId,
) {
    init {
...
enum class JimmerImmutableDraftPropRole {
    INHERITED_PRIMARY,
    REDEFINED,
    DECLARED,
}

enum class JimmerImmutableDraftAccessorStyle {
    KOTLIN_PROPERTY,
    JAVA_BEAN_GET,
    JAVA_BEAN_IS,
    JAVA_BARE,
...
enum class JimmerImmutableDraftValueState(
