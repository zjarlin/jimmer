...
fun generatedAnnotation(className: ClassName): AnnotationSpec =
    AnnotationSpec.builder(GENERATED_BY_CLASS_NAME)
        .addMember("type = %T::class", className)
        .build()

fun generatedAnnotation(type: ImmutableType): AnnotationSpec = generatedAnnotation(type.className)
