 ...
 */
internal data class KspLsiFileScopeInput(
    val file: KSFile,
 ...
 */
internal data class KspLsiFileScopePlan(
...
internal fun Collection<KSFile>.toKspLsiFileScopePlan(): KspLsiFileScopePlan {
...
internal fun Sequence<KSFile>.toStableKspFileList(): List<KSFile> {
...
internal fun KSFile.normalizedLsiSourcePath(): String {
