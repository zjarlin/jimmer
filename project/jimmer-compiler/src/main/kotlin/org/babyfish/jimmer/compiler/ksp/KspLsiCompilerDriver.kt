...
import site.addzero.lsi.ksp.KspCompilerInputResourceReader
import site.addzero.lsi.ksp.KspGeneratedArtifactWriter
import site.addzero.lsi.ksp.KspLsiFileScopeInput
import site.addzero.lsi.ksp.KspLsiRoundSymbols
import site.addzero.lsi.ksp.toKspLsiRoundSymbols
...
class KspLsiCompilerDriver(
    ...
    private val frontendOptions = options.toJimmerLsiFrontendOptions()
