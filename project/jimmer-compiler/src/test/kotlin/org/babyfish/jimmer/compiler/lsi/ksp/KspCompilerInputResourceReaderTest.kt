...
class KspCompilerInputResourceReaderTest {
    ...
    fun `reads existing resources ignores missing paths and freezes content`() {
        ...
        val entities = generatedRoot.resolve("resources/META-INF/jimmer/entities")
        entities.parentFile.mkdirs()
        entities.writeText("demo.Book\n")
        val immutables = generatedRoot.resolve("resources/META-INF/jimmer/immutables")
        ...
        assertEquals("demo.Book\n", snapshot.getValue("META-INF/jimmer/entities"))
        assertEquals("demo.Author\n", snapshot.getValue("META-INF/jimmer/immutables"))
        ...
        assertEquals(
            "demo.ChangedBook\n",
            reader.read(setOf("META-INF/jimmer/entities"))
                .getValue("META-INF/jimmer/entities"),
        )
    }
