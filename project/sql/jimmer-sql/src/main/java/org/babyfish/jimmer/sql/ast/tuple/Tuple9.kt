...
data class Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>@JsonCreator constructor(
    @JsonProperty("_1") val _1: T1,
    @JsonProperty("_2") val _2: T2,
    @JsonProperty("_3") val _3: T3,
    @JsonProperty("_4") val _4: T4,
    @JsonProperty("_5") val _5: T5,
    @JsonProperty("_6") val _6: T6,
    @JsonProperty("_7") val _7: T7,
    @JsonProperty("_8") val _8: T8,
    @JsonProperty("_9") val _9: T9
) : TupleImplementor {
